...
<body>
	...
	<div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
		<div class="container d-flex">
			<div class="contact-info mr-auto">
				<i class="icofont-envelope"></i> <a href="mailto:contact@epass.com">contact@epass.com</a>
				<i class="icofont-phone"></i> 9484798210 <i
					class="icofont-google-map"></i> Coimbatore, India.
			</div>
		</div>
	</div>
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<h2 class="logo mr-auto">
				<a href="index.jsp">E-Pass Travelling System</a>
			</h2>
	...
	<section id="hero" class="d-flex align-items-center">
		<div class="container">
			<h3>
				<strong><font color="white">Welcome To E-Pass
						Travelling System</font></strong>
			</h3>
		</div>
	</section>
	<!-- End Hero -->
		...
		<section id="about" class="about">
			<div class="container">
				<div class="section-title">
					<h2>About</h2>
					<p>E-Pass Management system is a web-based technology that will
	...
	<footer id="footer">
		<div class="container d-md-flex py-4">
			<div class="mr-md-auto text-center text-md-left">
				<div class="copyright">&copy 2020 E-Pass Travelling System.</div>
			</div>
